    ...
    <a class="navbar-brand" href="#"><img
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
            ...
            <form action="recherche.jsp"  method="post" class="me-auto search-form" target="_self">
                <div class="d-flex align-items-center"><label class="form-label d-flex mb-0" for="search-field"><i class="fa fa-search"></i></label><input  placeholder="rechercher selon la fonction demandé" style="width:600px" class="form-control search-field" type="search" id="search-field" name="search"></div>
...
<%
    ...
    String req = "select * from user where fctconcepteur = ? ";
    String img = null;
    Blob image = null;
    byte[] imgData = null;
    ...
    try {
        ...
        if (res.next()) {
            do {
                ...
                String fonction = res.getString(8);
                ...
                out.print("<h4 class='card-title'>"+username+"</h4>"
                        ...
                        +"<br> <b style='color:red'>fonction : </b>" +fonction+"<br>"+
                        "</p>"+"<a href='#' class='btn btn-primary stretched-link'>contacter</a>"
