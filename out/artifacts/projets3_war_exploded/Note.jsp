                ...
                if (res.next()) {
                    do {
                        ...
                        out.print(" <strong> Titre d'offre :</strong> <h4 class='card-title'>" + nom_offre + "</h4>"
                                ...
                                "<input value='"+nom_offre+"' type=\"hidden\"  name='Titre'/>"+"  <div> <select name='Note' class=form-control>\n" +
                                " <option value=1>1</option>\n" +
                                " <option value=2>2</option>\n" +
                                " <option value=3>3</option>\n" +
                                        " <option value=4>4</option>\n"+
                                        " <option value=5>5</option>\n"+
                                "</select><button  class=\"btn btn-success\" style=\"margin-right:3px\"   type='submit'> Noter </button></div></form>"
